...
| update-manager | [1105371](https://bugs.launchpad.net/bugs/1105371) | Screen reader: announce status header for update dialogue . Although that was claimed to be fixed in the prevoius version, the part of the patch corresponding to it was actually left behind. |
...
| linux-nvidia-lowlatency | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux-nvidia | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-nvidia | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-nvidia-tegra | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux-nvidia-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| ubuntu-drivers-common | [2085962](https://bugs.launchpad.net/bugs/2085962) | fix searching for lrm drivers matching linux-image-virtual |
| linux-aws | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-aws | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-gcp | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-gcp | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-gke | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-gke | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-ibm | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-ibm | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-lowlatency | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-lowlatency | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-oracle | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-oracle | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-riscv | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-riscv | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-oem-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-oem-6.11 | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-gcp-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-gcp-6.11 | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-oem-6.8 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-oem-6.8 | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-hwe-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-hwe-6.11 | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-azure | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux-lowlatency-hwe-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
| linux-lowlatency-hwe-6.11 | [2067900](https://bugs.launchpad.net/bugs/2067900) | apparmor unconfined profile blocks pivot_root |
| linux-azure-6.11 | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux-oem-6.11 | [2103753](https://bugs.launchpad.net/bugs/2103753) | Run sysfs_attachment will be stucked forever (HID- SENSOR-200011.16.auto/iio:device4) |
| linux-oem-6.11 | [2103680](https://bugs.launchpad.net/bugs/2103680) | System hangs when running the memory stress test |
...
| linux-firmware | [2101841](https://bugs.launchpad.net/bugs/2101841) | Dell AIO of Intel ARL platform may hang after playing video streaming |
...
| linux-azure-nvidia | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux-oem-6.11 | [2107439](https://bugs.launchpad.net/bugs/2107439) | Cannot recongnize two 4k@60hz external monitors on SD25 DOCK |
...
| linux-raspi | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
| linux | [2095370](https://bugs.launchpad.net/bugs/2095370) | AppArmor early policy load not funcitoning |
...
Source Package | Bug  # | Description
--- | --- | ---
| openldap | [2090806](https://bugs.launchpad.net/bugs/2090806) | Fixup TIMEOUT and NETWORK_TIMEOUT options so they work correctly when SSL is involved. Before they would never timeout, causing hangs on connection failure. Now they timeout as expected. |
...
| gce-compute-image-packages | [2106195](https://bugs.launchpad.net/bugs/2106195) | New uptream version for upstream tag 20250328.00. |
